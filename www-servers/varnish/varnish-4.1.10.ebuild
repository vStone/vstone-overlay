...
src_prepare() {
	...
	sed -i -e 's/@CURSES_LIB@/@CURSES_LIBS@/g'  $( find -name Makefile.am )
	sed -i -e 's/@CURSES_LIB@/@CURSES_LIBS@/g'  $( find -name Makefile.in )
	cp -v "${FILESDIR}/ax_with_curses.m4.18" m4/ax_with_curses.m4
